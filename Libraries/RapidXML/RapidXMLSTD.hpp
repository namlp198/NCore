...
typedef rapidxml::xml_document<> XMLDocument_2;
...
extern "C"
{
	...
	* @param error - An error message
	* @returns The element, if success*/
	DLL_EX XMLElement* FirstOrDefaultElementA(XMLDocument_2* parent, const std::string& elementName, std::string& error);
	...
	* @returns A xml document*/
	DLL_EX XMLDocument_2* CreateXMLFromFile(XMLFile* file, std::string& error);
	/**Creates a new XML file
	* @param version - the version of the XML format
	* @param encoding - The Encoding of the XML file (eg: utf-8, utf-16)
	* @param error - An error message
	* @returns A xml document*/
	DLL_EX XMLDocument_2* CreateXML(const uint8_t& version, const std::string& encoding, std::string& error);
	/**Disposes resources.
	* @param doc - A xml document object
	* @returns True if success*/
	DLL_EX const bool DisposeXMLObject(XMLDocument_2* doc);
	/**Saves and XML object to a file
	* @param doc - A xml document object
	* @param filePath - The path to an xml file
	* @param error - An error message
	* @returns True if success*/
	DLL_EX const bool SaveXML(const XMLDocument_2& doc, const std::string& filePath);
	...
	* @param error - An error message
	* @returns True if success*/
	DLL_EX const bool SetHeader(XMLDocument_2* doc, const uint8_t& version, const std::string& encoding, std::string& error);
	/**Sets the default xsi and xsd namespaces
	* @param doc - A xml document object
	* @param element - The element to set the namespace
	* @param error - An error message
	* @returns True if success*/
	DLL_EX const bool SetElementDefaultNamespaces(XMLDocument_2* doc, XMLElement* element, std::string& error);
	...
	* @param error - An error message
	* @returns True if success*/
	DLL_EX const bool SetElementNamespaces(XMLDocument_2* doc, XMLElement* element, const std::string& xsi, const std::string& xsd, std::string& error);
	/**Adds an element to a xml document
	* @param doc - A xml document object
	* @param element - The element add
	* @param error - An error message
	* @returns True if success*/
	DLL_EX const bool AddElementToDocument(XMLDocument_2* doc, XMLElement* element, std::string& error);
	...
	* @param error - An error message
	* @returns True if success*/
	DLL_EX XMLAttributte* CreateAttribute(XMLDocument_2* doc, const std::string& attributeName, const std::string& attributeValue, std::string& error);
	/**Creates a element
	* @param doc - A xml document object
	* @param elementName - The name of the element
	...
	* @param error - An error message
	* @returns True if success*/
	DLL_EX XMLElement* CreateElement(XMLDocument_2* doc, const std::string& elementName, const std::string& elementValue, std::string& error);
	/**Creates a element
	* @param doc - A xml document object
	* @param elementName - The name of the element
	...
	* @param error - An error message
	* @returns True if success*/
	DLL_EX XMLElement* CreateElementA(XMLDocument_2* doc, const std::string& elementName, XMLElement** subElements, const size_t& subElementCount, std::string& error);
};
