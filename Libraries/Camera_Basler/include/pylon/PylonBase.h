...
/**
  ...
  */
    ...
    /**
        \brief Returns the given version numbers as Pylon::String_t.
        */
    PYLONBASE_API Pylon::String_t CDECL GetVersionString( unsigned int major, unsigned int minor, unsigned int subminor, unsigned int build );
