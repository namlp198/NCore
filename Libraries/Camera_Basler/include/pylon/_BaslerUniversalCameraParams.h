...
namespace Basler_UniversalCameraParams
{
    ...
    {
        AcquisitionMode_Continuous,  //!< The acquisition mode is set to Continuous - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        AcquisitionMode_MultiFrame,  //!< The acquisition mode is set to Multi Frame - Applies to: CameraLink and GigE
        AcquisitionMode_SingleFrame  //!< The acquisition mode is set to Single Frame - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        AutoFunctionROISelector_ROI1,  //!< Auto function ROI 1 can be configured - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
    ...
    {
        BalanceRatioSelector_Blue,  //!< Balance ratio is applied to the blue channel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        BalanceRatioSelector_Green,  //!< Balance ratio is applied to the green channel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        BalanceRatioSelector_Red  //!< Balance ratio is applied to the red channel - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };

    //! Valid values for BalanceWhiteAuto
    enum BalanceWhiteAutoEnums
    {
        BalanceWhiteAuto_Continuous,  //!< White balance is adjusted continuously while images are being acquired - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        BalanceWhiteAuto_Off,  //!< The Balance White Auto auto function is disabled - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        BalanceWhiteAuto_Once  //!< White balance is adjusted automatically to reach the specified target value - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    enum BinningHorizontalModeEnums
    {
        ...
        BinningHorizontalMode_Sum  //!< The values of the binned pixels are summed - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        BinningSelector_Region1,  //!< FPGA binning can be configured - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
    ...
    enum BinningVerticalModeEnums
    {
        ...
        BinningVerticalMode_Sum  //!< The values of the binned pixels are summed - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        BslDualROIRowSelector_Row1,  //!< Row 1 can be configured - Applies to: boost_V_CoaXPress
        BslDualROIRowSelector_Row2  //!< Row 2 can be configured - Applies to: boost_V_CoaXPress
    };

    //! Valid values for BslEnableFan
    enum BslEnableFanEnums
    {
        BslEnableFan_Off,  //!< The external fan is switched off - Applies to: boost_V_CoaXPress
        BslEnableFan_On  //!< The external fan is switched on - Applies to: boost_V_CoaXPress
    };
    ...
    {
        BslFlatFieldCorrectionMode_DSNUOnly,  //!< Only Dark Signal Non-Uniformity (DSNU) correction is performed - Applies to: boost_V_CoaXPress
        BslFlatFieldCorrectionMode_Off,  //!< Flat-field correction is disabled - Applies to: boost_V_CoaXPress
        BslFlatFieldCorrectionMode_On  //!< Flat-field correction is enabled - Applies to: boost_V_CoaXPress
    };
    ...
    {
        BslImageStamp_Off,  //!< Image stamping is disabled - Applies to: boost_V_CoaXPress
        BslImageStamp_On  //!< Image stamping is enabled - Applies to: boost_V_CoaXPress
    };
    ...
    {
        BslStaticDefectPixelCorrectionMode_Factory,  //!< Static defect pixel correction is based on the defect pixels stored in the factory correction file - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and boost_V_CoaXPress
        BslStaticDefectPixelCorrectionMode_Off,  //!< Static defect pixel correction is disabled - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and boost_V_CoaXPress
        BslStaticDefectPixelCorrectionMode_User  //!< Static defect pixel correction is based on the defect pixels stored in the user correction file - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and boost_V_CoaXPress
    };

    //! Valid values for BslStaticDefectPixelCorrectionTestMode
    enum BslStaticDefectPixelCorrectionTestModeEnums
    {
        BslStaticDefectPixelCorrectionTestMode_Off,  //!< Static defect pixel correction test mode is disabled   - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionTestMode_On  //!< Static defect pixel correction test mode is enabled   - Applies to: boost_V_CoaXPress
    };

    //! Valid values for BslStaticDefectPixelCorrectionXSelector
    enum BslStaticDefectPixelCorrectionXSelectorEnums
    {
        BslStaticDefectPixelCorrectionXSelector_X0,  //!< Entry X0 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X1,  //!< Entry X1 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X2,  //!< Entry X2 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X3,  //!< Entry X3 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X4,  //!< Entry X4 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X5,  //!< Entry X5 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X6,  //!< Entry X6 can be configured - Applies to: boost_V_CoaXPress
        BslStaticDefectPixelCorrectionXSelector_X7  //!< Entry X7 can be configured - Applies to: boost_V_CoaXPress
    };

    //! Valid values for BslTemperatureStatus
    enum BslTemperatureStatusEnums
    {
        BslTemperatureStatus_Critical,  //!< The temperature is close to or at the allowed maximum  Provide cooling - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        BslTemperatureStatus_Error,  //!< The temperature is above the allowed maximum  Provide cooling immediately - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        BslTemperatureStatus_Ok  //!< The temperature is within the normal operating temperature range - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
    };
    ...
    {
        CxpConnectionTestMode_Mode1,  //!< Test mode is enabled - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpConnectionTestMode_Off  //!< Test mode is disabled - Applies to: boost CoaXPress and boost_V_CoaXPress
    };
    ...
    enum CxpLinkConfigurationEnums
    {
        ...
        CxpLinkConfiguration_CXP12_X1,  //!< The link configuration is set to 1 connection operating at CXP-12 speed (12 5 Gbps) - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpLinkConfiguration_CXP12_X2,  //!< The link configuration is set to 2 connections operating at CXP-12 speed (12 5 Gbps) - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpLinkConfiguration_CXP12_X4,  //!< The link configuration is set to 4 connections operating at CXP-12 speed (12 5 Gbps) - Applies to: boost_V_CoaXPress
        ...
        CxpLinkConfiguration_CXP6_X2,  //!< The link configuration is set to 2 connections operating at CXP-6 speed (6 25 Gbps) - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpLinkConfiguration_CXP6_X4  //!< The link configuration is set to 4 connections operating at CXP-6 speed (6 25 Gbps) - Applies to: boost_V_CoaXPress
    };
    ...
    enum CxpLinkConfigurationPreferredEnums
    {
        ...
        CxpLinkConfigurationPreferred_CXP12_X1,  //!< The link configuration is set to 1 connection operating at CXP-12 speed (12 5 Gbps) - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpLinkConfigurationPreferred_CXP12_X2,  //!< The link configuration is set to 2 connections operating at CXP-12 speed (12 5 Gbps) - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpLinkConfigurationPreferred_CXP12_X4,  //!< The link configuration is set to 4 connections operating at CXP-12 speed (12 5 Gbps) - Applies to: boost_V_CoaXPress
        ...
        CxpLinkConfigurationPreferred_CXP6_X2,  //!< The link configuration is set to 2 connections operating at CXP-6 speed (6 25 Gbps) - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpLinkConfigurationPreferred_CXP6_X4  //!< The link configuration is set to 4 connections operating at CXP-6 speed (6 25 Gbps) - Applies to: boost_V_CoaXPress
    };
    ...
    {
        CxpSendReceiveSelector_Receive,  //!< The receive features can be configured - Applies to: boost CoaXPress and boost_V_CoaXPress
        CxpSendReceiveSelector_Send  //!< The send features can be configured - Applies to: boost CoaXPress and boost_V_CoaXPress
    };
    ...
    {
        DeviceIndicatorMode_Active,  //!< The status LED of the camera is turned on - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        DeviceIndicatorMode_Inactive  //!< The status LED of the camera is turned off - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
    };
    ...
    {
        DeviceScanType_Areascan,  //!< The camera has an area scan sensor - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    {
        DeviceTLType_CoaXPress,  //!< The device provides a CoaXPress transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        DeviceTLType_Custom,  //!< The device provides a custom transport layer - Applies to: dart MIPI
        DeviceTLType_GigEVision,  //!< The device provides a GigE Vision transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        DeviceTLType_USB3Vision  //!< The device provides a USB3 Vision transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
    };

    //! Valid values for DeviceTapGeometry
    enum DeviceTapGeometryEnums
    {
        DeviceTapGeometry_Geometry_1X_1Y,  //!< The tap geometry is set to 1 zone in horizontal direction with one tap and 1 zone in vertical direction with 1 tap - Applies to: boost CoaXPress and boost_V_CoaXPress
        DeviceTapGeometry_Geometry_1X_2YE  //!< The tap geometry is set to 1 zone in horizontal direction with one tap and 2 zones in vertical direction with 1 tap with end extraction - Applies to: boost_V_CoaXPress
    };
    ...
    enum DeviceTemperatureSelectorEnums
    {
        ...
        DeviceTemperatureSelector_FpgaCore,  //!< The temperature is measured on the FPGA board - Applies to: boost CoaXPress, boost_V_CoaXPress and dart 2 USB
    ...
    enum ExposureModeEnums
    {
        ...
        ExposureMode_Timed,  //!< The exposure mode is set to Timed - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        ExposureMode_TriggerWidth  //!< The exposure mode is set to Trigger Width - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
    };
    ...
    enum LineFormatEnums
    {
        ...
        LineFormat_LVTTL,  //!< The line is currently accepting or sending LVTTL level signals - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        LineFormat_NoConnect,  //!< The line is not connected - Applies to: CameraLink, GigE and ace USB
        LineFormat_OpenDrain,  //!< The output of the line is "open drain"/"open collector" - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        LineFormat_OptoCoupled,  //!< The line is opto-coupled - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
    ...
    enum LineModeEnums
    {
        ...
        LineMode_Input,  //!< The selected physical line can be used to input an electrical signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        LineMode_Output  //!< The selected physical line can be used to output an electrical signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
    };
    ...
    enum LineSelectorEnums
    {
        ...
        LineSelector_Line1,  //!< Line 1 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        LineSelector_Line2,  //!< Line 2 can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
    ...
    enum LineSourceEnums
    {
        ...
        LineSource_ExposureActive,  //!< The source signal for the currently selected line is set to Exposure Active - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        LineSource_Off,  //!< No source signal is set for the currently selected line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
    ...
    enum PixelFormatEnums
    {
        ...
        PixelFormat_BayerBG10,  //!< The pixel format is set to Bayer BG 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerBG12,  //!< The pixel format is set to Bayer BG 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerBG8,  //!< The pixel format is set to Bayer BG 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGB10,  //!< The pixel format is set to Bayer GB 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerGB12,  //!< The pixel format is set to Bayer GB 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerGB8,  //!< The pixel format is set to Bayer GB 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerGR10,  //!< The pixel format is set to Bayer GR 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerGR12,  //!< The pixel format is set to Bayer GR 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerGR8,  //!< The pixel format is set to Bayer GR 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        PixelFormat_BayerRG10,  //!< The pixel format is set to Bayer RG 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_BayerRG12,  //!< The pixel format is set to Bayer RG 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_BayerRG8,  //!< The pixel format is set to Bayer RG 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_Mono10,  //!< The pixel format is set to Mono 10 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        PixelFormat_Mono12,  //!< The pixel format is set to Mono 12 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        PixelFormat_Mono8,  //!< The pixel format is set to Mono 8 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    enum TestPatternEnums
    {
        ...
        TestPattern_Off,  //!< No test pattern is generated - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        TestPattern_Testimage1,  //!< The camera generates a test image with the test image 1 pattern - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
    ...
    enum TriggerActivationEnums
    {
        ...
        TriggerActivation_RisingEdge  //!< The selected trigger is activated by the rising edge of the source signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    {
        TriggerMode_Off,  //!< The currently selected trigger is turned off - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        TriggerMode_On  //!< The currently selected trigger is turned on - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    enum TriggerSelectorEnums
    {
        ...
        TriggerSelector_ExposureStart,  //!< The Exposure Start trigger can be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
    ...
    enum TriggerSourceEnums
    {
        ...
        TriggerSource_CXPTrigger0,  //!< The CXP Trigger 0 trigger can be configured - Applies to: boost_V_CoaXPress
        ...
        TriggerSource_Line1,  //!< The source signal for the selected trigger is set to Line 1 - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        TriggerSource_Software,  //!< The source signal for the selected trigger is set to software triggering - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    enum UserSetDefaultEnums
    {
        ...
        UserSetDefault_Default,  //!< The Default User Set factory set is set as the default startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        UserSetDefault_UserSet1,  //!< User set 1 is set as the default startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
    ...
    enum UserSetSelectorEnums
    {
        ...
        UserSetSelector_Default,  //!< The Default User Set factory set can be loaded - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        UserSetSelector_UserSet1,  //!< User set 1 can be saved, loaded, or configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
    ...
    //**************************************************************************************************
    // Parameter class CUniversalCameraParams_Params_v7_4_0
    //**************************************************************************************************
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class PYLONBASE_API CUniversalCameraParams_Params_v7_4_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalCameraParams_Params_v7_4_0( void );
    ...
    private:
        class CUniversalCameraParams_Params_v7_4_0_Data;
        CUniversalCameraParams_Params_v7_4_0_Data* m_pCUniversalCameraParams_Params_v7_4_0_Data;
    ...
    public:
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition frame rate of the camera in frames per second - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the image acquisition mode - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Starts the acquisition of images - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Stops the acquisition of images - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the auto function ROI (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Highlights the current auto function ROI in the image window - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the auto function ROI from the left side of the sensor (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset from the top of the sensor to the auto function ROI (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which auto function ROI can be configured - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Assigns the Balance White Auto auto function to the currently selected auto function ROI - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the auto function ROI (in pixels) - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Balance Ratio value to be applied to the currently selected channel - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which color channel can be adjusted when performing manual white balance - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Balance White Auto auto function - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent horizontal pixels to be summed - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for horizontal binning - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether sensor or FPGA binning can be configured - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent vertical pixels to be summed - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for vertical binning - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Black level value to be applied to the currently selected sensor tap - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates whether the outgoing image is valid - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset of the currently selected row - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which row can be configured - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the currently selected row - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the Dual ROI feature - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the external fan if one is connected - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Dark Signal Non-Uniformity (DSNU) coefficient of the column specified by the Flat-Field Correction Coeff X parameter - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Photo Response Non-Uniformity (PRNU) coefficient of the column specified by the Flat-Field Correction Coeff X parameter - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Column used for flat-field correction - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief The mean gray value of all pixels in the dark field image - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the flat-field correction mode - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Saves current flat-field correction values to flash memory - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief User-defined global dark offset used for flat-field correction - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Enables image stamping - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Time period in which the camera evaluates all changes and durations of logical states of the input signal   - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Time period in which the camera doesn't accept any further trigger signals or signal changes after receiving an input trigger signal - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Clears all custom defect pixel coordinates - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates how many defect pixels are being corrected - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the static defect pixel correction mode - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Saves changes to the defect pixel coordinates to flash memory - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Enables or disables the static defect pixel correction test mode - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief X coordinate of the defect pixel to be corrected - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets which x coordinate entry can be configured - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Y coordinate of the defect pixel to be corrected - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the temperature state - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the CoaXPress physical connection to control - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Number of test packet connection errors received by the device on the connection selected by the Connection Selector parameter - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test mode for an individual physical connection of the device - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Number of test packets received by the device on the connection selected by the Cxp Connection Selector parameter - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the link configuration - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the link configuration that allows the device to operate in its default mode - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Sets whether the send or the receive features can be configured - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical decimation factor - Applies to: CameraLink, GigE, ace USB and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Identifier of the product family of the device - Applies to: ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera's firmware - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the behavior of the camera's status LED - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the schema file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the schema file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the schema file of the selected manifest entry - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the GenICam XML file of the selected manifest entry - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Additional information from the vendor about the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera model - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Immediately resets and restarts the camera - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the SFNC specification that the camera is compatible with - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the SFNC specification that the camera is compatible with - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the SFNC specification that the camera is compatible with - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the scan type of the camera's sensor (area or line scan) - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Serial number of the camera - Applies to: ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the type of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Major version number of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Minor version number of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Subminor version number of the device's transport layer - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the tap geometry - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Temperature at the selected location in the camera (in degrees centigrade) - Applies to: ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the location in the camera where the temperature will be measured - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress and dart 2 USB
        ...
        */
        ...
        //@{
        /*!
            \brief User-settable ID of the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Name of the camera vendor - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Version of the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the exposure mode - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera in microseconds - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the currently selected gain in dB - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum height of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Stream ID of the first image stream - Applies to: boost CoaXPress and boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Stream ID of the second image stream - Applies to: boost_V_CoaXPress
        ...
        */
        ...
        //@{
        /*!
            \brief Indicates the electrical configuration of the currently selected line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the signal inverter function for the currently selected input or output line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the selected line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the I/O line to be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the currently selected line - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Horizontal offset of the region of interest (area of interest) from the left side of the sensor (in pixels) - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Vertical offset of the region of interest (area of interest) from the top of the sensor (in pixels) - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Size of the payload in bytes - Applies to: CamEmu, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the format of the pixel data transmitted by the camera - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables horizontal mirroring of the image - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables vertical mirroring of the image - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
  ...
  errors causing planar surfaces to appear curved.
        ...
        */
        ...
        //@{
        /*!
            \brief Height of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's sensor in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the test pattern to display - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will activate the selected trigger - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay time in microseconds - Applies to: CamEmu, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the currently selected trigger - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the trigger type to be configured - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Generates a software trigger signal - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the selected trigger - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to be used as the startup set - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Loads the selected set into the camera's volatile memory and makes it the active configuration set - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Saves the current active set as the selected user set - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user set or the factory set to load, save, or configure - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Width of the camera's region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Maximum width of the region of interest (area of interest) in pixels - Applies to: CamEmu, CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, boost_V_CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalCameraParams_Params_v7_4_0(CUniversalCameraParams_Params_v7_4_0&);

        //! not implemented assignment operator
        CUniversalCameraParams_Params_v7_4_0& operator=(CUniversalCameraParams_Params_v7_4_0&);
    ...
    The \ref sample_ParametrizeCamera_NativeParameterAccess code sample shows how to access camera parameters via the \c Pylon::CBaslerUniversalInstantCamera class.
    */
    class CUniversalCameraParams_Params : public CUniversalCameraParams_Params_v7_4_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalCameraParams_Params_v7_4_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalCameraParams
