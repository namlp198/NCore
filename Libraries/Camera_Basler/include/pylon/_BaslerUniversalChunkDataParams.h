...
namespace Basler_UniversalChunkDataParams
{
    ...
    //**************************************************************************************************
    // Parameter class CUniversalChunkDataParams_Params_v7_4_0
    //**************************************************************************************************
    ...
    More information can be found in the code of the \ref sample_Grab_ChunkImage sample.
    */
    class PYLONBASE_API CUniversalChunkDataParams_Params_v7_4_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        //! Constructor
        CUniversalChunkDataParams_Params_v7_4_0( void );
    ...
    private:
        class CUniversalChunkDataParams_Params_v7_4_0_Data;
        CUniversalChunkDataParams_Params_v7_4_0_Data* m_pCUniversalChunkDataParams_Params_v7_4_0_Data;
    ...
    //! \cond HIDE_CLASS_METHODS
        ...
        CUniversalChunkDataParams_Params_v7_4_0(CUniversalChunkDataParams_Params_v7_4_0&);

        //! not implemented assignment operator
        CUniversalChunkDataParams_Params_v7_4_0& operator=(CUniversalChunkDataParams_Params_v7_4_0&);
    ...
    More information can be found in the code of the \ref sample_Grab_ChunkImage sample.
    */
    class CUniversalChunkDataParams_Params : public CUniversalChunkDataParams_Params_v7_4_0
    {
    //----------------------------------------------------------------------------------------------------------------
    // Implementation
    //----------------------------------------------------------------------------------------------------------------
    protected:
        ...
        {
            CUniversalChunkDataParams_Params_v7_4_0::_Initialize( pNodeMap );
        }
        //! \endcond
    };
} // namespace Basler_UniversalChunkDataParams
