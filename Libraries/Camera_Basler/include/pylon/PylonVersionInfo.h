    ...
    */
    ...
    public:
        ...
        explicit VersionInfo( bool checkBuild = false )
            ...
            , m_versionString( Pylon::GetVersionString( m_major, m_minor, m_subminor, m_build ) )
        {
        ...
        VersionInfo( unsigned int major,
            ...
            , m_build( 0 )
            , m_checkBuild( false )
            , m_versionString( Pylon::GetVersionString( major, minor, subminor, m_build ) )
        {
        }
        ...
        VersionInfo( unsigned int major,
            ...
            , m_build( build )
            , m_checkBuild( true )
            , m_versionString( Pylon::GetVersionString( major, minor, subminor, build ) )
        {
        }
    ...
    public:
        ...
        static const char* getPylonVersionString()
        {
    ...
    protected:
        ...
        bool            m_checkBuild;
        Pylon::String_t m_versionString;
    };
}
