...
class AFX_EXT_CLASS CLightControls_NVSystem_AKP6 : public CLightControls, public ISerialPort2Parent
{
public:
	CLightControls_NVSystem_AKP6(int nIndex, ILightControls2Parent* pILC2P);
	virtual ~CLightControls_NVSystem_AKP6(void);
