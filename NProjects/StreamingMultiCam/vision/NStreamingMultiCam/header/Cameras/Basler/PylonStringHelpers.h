...
// Auto conversion class: UTF-8 to wchar_t (pylon to MFC).
// All strings in pylon are single byte UTF-8 encoded. MFC uses wide UTF-16 strings.
// These conversion classes can be used to convert between these encodings.
// See ATL/MFC String conversion in MSDN for further documentation.
class AFX_EXT_CLASS CUtf82W : public CA2W
{
public:
...
// Auto conversion class: wchar_t to UTF-8. (MFC to pylon)
// All strings in pylon are single byte UTF-8 encoded. MFC uses wide UTF-16 strings.
// These conversion classes can be used to convert between these encodings.
// See ATL/MFC String conversion in MSDN for further documentation.
